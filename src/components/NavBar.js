                        ...
                        <nav className="hidden md:flex space-x-10">
                            <div className="relative">
                                <ul className="menu menu-horizontal p-0">
                                    <li tabIndex="0">
                                        <Link to='/' type="button" className="text-gray-500 group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" aria-expanded="false">Shop</Link>
                                    ...
                                    <li tabIndex="0">
                                        <a href="/#" className="text-base font-medium text-gray-500 hover:text-gray-900"> Contacto </a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
