    ...
    <div className="bg-gray-800 text-gray-100 px-8 py-12">
      <div
        ...
        <div className="flex flex-col justify-between">
          <div>
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight">Hablemos de todo un poco!</h2>
            <div className="text-gray-700 mt-8">
              Odias los Formularios? Envianos un <span className="underline">email</span>.
            </div>
          </div>
        ...
        <div className="">
          <div>
            <span className="uppercase text-sm text-gray-600 font-bold">Nombre y Apellido</span>
      ...
      <div
        className="grid place-items-center max-w-screen-xl mt-24 px-8 gap-8 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
        <p className="text-xl font-bold">OTROS MEDIOS DE CONTACTO</p>
        <div className="flex w-full">
          <div className="grid h-20 w-20 rounded-box place-items-center">
            <a href="https://api.whatsapp.com/send?phone=5493513528111&text=Hola%20Classics.%20!" target="_blank" rel="noopener noreferrer">
              <img src="https://i.ibb.co/z7jRC79/Dise-o-sin-t-tulo-6.png" alt="" />
            </a>
          </div>
          <div className="divider divider-horizontal"></div>
          <div className="grid h-20 w-20 rounded-box place-items-center">
            <a href="mailto:jeretardivo1992@gmail.com?Subject=Contacto%20desde%20Classics" target="_blank" rel="noopener noreferrer">
              <img src="https://i.ibb.co/NLwfFKG/Dise-o-sin-t-tulo-7.png" alt="" />
            </a>
          </div>
        </div>
      </div>
