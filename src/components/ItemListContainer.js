...
const ItemListContainer = (props) => { 
    return (
        <>
            <div className="flex font-sans bg-blue-100 aspect-square">
                <div className="flex-none w-56 relative">
                    <img src="\assets\camisteTitular.jpeg" alt="" className="absolute inset-0 w-full h-full object-cover rounded-lg" />
                </div>
